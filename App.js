...
export default function App() {
  ...
  return (
    <View style={styles.container}>
        <Text style={styles.titulo}>Formulario citas</Text>
        <Formulario/>
        <Text style={styles.titulo}> { citas.length > 0 ? 'Administar Citas' : 'No hay citas, agrega una'} </Text>
        <FlatList
          data={citas}
